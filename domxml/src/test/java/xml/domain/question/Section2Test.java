...
import xml.domain.root.Section;
...
public class Section2Test {
	...
	@Test
	public void shouldLoadSerialize() throws IOException {
		mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);

		InputStream is = getClass().getClassLoader().getResourceAsStream("section.json");
		String jsonTxt = IOUtils.toString(is, "UTF-8");
		Section section = mapper.readValue(jsonTxt, Section.class);
